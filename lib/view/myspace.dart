                                ...
                                image: allphanesuserdata!
                                    ...
                                    : DecorationImage(
                                        image: CachedNetworkImageProvider(
                                            "${allphanesuserdata!.getString("coverphoto")}"),
                                        fit: BoxFit.fill)),
                          ),
                          Container(
                            height: 25.h,
                            ...
                            child: Row(
                              children: [
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          //color: Colors.white,
                                          image: myspacedata["responseData"][0]
                                                          ["user_info"][0]
                                                      ["profilePhoto"] ==
                                                  ""
                                              ? DecorationImage(
                                              ...
                                              : DecorationImage(
                                                  image: CachedNetworkImageProvider(
                                                      "${myspacedata["responseData"][0]["user_info"][0]["profilePhoto"]}"),
                                                  fit: BoxFit.fill)),
                                    ),
                                    Positioned(
                                      top: 4.h,
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 10),
                                  child: Text(
                                    "${myspacedata["responseData"][0]["user_info"][0]["showName"]}",
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 3.h,
                                        fontWeight: FontWeight.bold),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "FRIENDS",
                                  style: TextStyle(
                                      color: Colors.grey, fontSize: 4.w),
                                )
                              ],
                            ),
                          ),
                              ...
                              Container(
                                ...
                                child: TabBarView(
                                  children: [
                                    ...
                                    ListView.builder(
                                      itemCount:
                                          myspacedata["responseData"].length > 0
                                              ? myspacedata["responseData"]
                                                  .length
                                              : 0,
                                      itemBuilder:
                                                          ...
                                                          children: [
                                                            Padding(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                decoration: BoxDecoration(
                                                                    shape: BoxShape.circle,
                                                                    //color: Colors.green,
                                                                    image: myspacedata["responseData"][index]["user_info"][0]["profilePhoto"] != ""
                                                                        ? DecorationImage(
                                                                            image: NetworkImage(
                                                                              "${myspacedata["responseData"][index]["user_info"][0]["profilePhoto"]}",
                                                                            ),
                                                                            fit: BoxFit.fill)
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: FittedBox(
                                                                  ...
                                                                  child: SizedBox(
                                                                      child: Text(
                                                                          "${myspacedata["responseData"][index]["user_info"][0]["showName"]}",
                                                                          style: TextStyle(
                                                                              fontSize: 2.5.w,
                                                                              fontWeight: FontWeight.bold),
                                                            ...
                                                            children: [
                                                              IconButton(
                                                                  ...
                                                                  IconButtonsTap
                                                                      ...
                                                                      await new IconButtonsTap(
                                                                          allphanesuserdata!
                                                                              .getString("userid"));
                                                                  tap.TapOnFavorite(
                                                                          myspacedata["responseData"][index]
                                                                              [
                                                                              "referenceUserId"],
                                                                          myspacedata["responseData"][index]
                                                                              [
                                                                ...
                                                                icon: Icon(
                                                                  Icons
                                                                      .bookmark,
                                                                  color: myspacedata["responseData"][index]["isFav"]
                                                                                  .length >
                                                                              0 &&
                                                                          myspacedata["responseData"][index]["isFav"][0]["mark"] ==
                                                                              false
                                                                      ? Colors
                                                                          .grey
                                                                      : Colors
                                                              ...
                                                              PopupMenuButton(
                                                                  itemBuilder: (_) =>
                                                                      <
                                                                        ...
                                                                        myspacedata["responseData"][index]["referenceUserId"] !=
                                                                                allphanesuserdata!.getString("userid")
                                                                            ? PopupMenuItem<String>(child: Text('Report'), value: 'report')
                                                                            : PopupMenuItem<String>(child: Text('Delete Post'), value: 'delete post'),
                                                                      ],
                                                                  onSelected:
                                                                      (_) {})
                                                            ],
                                                    ...
                                                    children: [
                                                      Text(
                                                        myspacedata["responseData"]
                                                                    ...
                                                                    "postTitle"] !=
                                                                "Quick Post"
                                                            ? "${myspacedata["responseData"][index]["postTitle"]}"
                                                            : "",
                                                        style: TextStyle(
                                                            color: Colors.black,
                                                            fontWeight:
                                                ...
                                                myspacedata["responseData"]
                                                    ...
                                                    ? Padding(
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            Image(
                                                                image: NetworkImage(
                                                                    "${myspacedata["responseData"][index]["postInfo"][0]["postImagePath"]}")
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                    myspacedata["responseData"][index]["keywords2"] !=
                                                                            null
                                                                        ? "${myspacedata["responseData"][index]["keywords2"]}"
                                                                        : "",
                                                                    style: TextStyle(
                                                    ...
                                                    : Padding(
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            Text(
                                                              "${myspacedata["responseData"][index]["postDescription"]}",
                                                              style: TextStyle(
                                                                  color: Colors
                                                                      .black,
                                                                  fontSize: 14),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                decoration: BoxDecoration(
                                                                                    shape: BoxShape.circle,
                                                                                    //color: Colors.green,
                                                                                    image: myspacedata["responseData"][index]["shareProfile"] != ""
                                                                                        ? DecorationImage(
                                                                                            image: CachedNetworkImageProvider(
                                                                                              "${myspacedata["responseData"][index]["shareProfile"]}",
                                                                                            ),
                                                                                            fit: BoxFit.fill)
                                                                                        : DecorationImage(image: AssetImage("images/default_profileimage.png"), fit: BoxFit.contain)),
                                                                              ),
                                                                  ...
                                                                  : Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Image(
                                                                            image:
                                                                                CachedNetworkImageProvider('${myspacedata["responseData"][index]["shareGalleryInfo"]}'),
                                                                            fit:
                                                                                BoxFit.contain,
                                                                          ),
                                                                          Row(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                "${myspacedata["responseData"][index]["shareDescription"]}",
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      IconButton(
                                                        icon: Icon(
                                                          Icons.favorite,
                                                          color: myspacedata["responseData"]
                                                                              [
                                                                              index]
                                                                          [
                                                                          "isLiked"]
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      TextButton(
                                                          onPressed: () {},
                                                          child: Text(
                                                            "${myspacedata["responseData"][index]["totalLikes"]} Likes",
                                                            style: TextStyle(
                                                                color:
                                                                    Colors.grey,
                                                                fontSize: 12),
                                                      ...
                                                      TextButton(
                                                          onPressed: () {},
                                                          child: Text(
                                                              "${myspacedata["responseData"][index]["totalComment"]} Comments",
                                                              style: TextStyle(
                                                                  color: Colors
                                                                      .grey,
                                                                  fontSize:
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                decoration: BoxDecoration(
                                                                    shape: BoxShape.circle,
                                                                    //color: Colors.green,
                                                                    image: allphanesuserdata!.getString("profilephoto") != ""
                                                                        ? DecorationImage(
                                                                            image: NetworkImage(
