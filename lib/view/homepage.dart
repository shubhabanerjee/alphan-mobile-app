        ...
        title: Row(
          ...
          children: [
            Container(
                ...
                width: 8.w,
                child: Image(
                  image: AssetImage("images/allphanes_icon1.png"),
                  fit: BoxFit.contain,
                )),
            Padding(
          ...
          child: mycanvasdata == null
              ...
              : Stack(
                  children: [
                    ...
                    ListView.builder(
                      itemCount: mycanvasdata != null
                          ? mycanvasdata["responseData"].length
                          : 0,
                      itemBuilder: (BuildContext context, index) {
                              ...
                              children: [
                                              ...
                                              child: GestureDetector(
                                                onTap: () async {
                                                  ...
                                                  Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                          builder: (context) => MySpace(
                                                              allphanesuserdata!
                                                                  .getString(
                                                                      "userid"),
                                                              mycanvasdata["responseData"]
                                                                          [
                                                                          index]
                                                                      [
                                                                      "user_info"]
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                      shape: BoxShape.circle,
                                                      //color: Colors.green,
                                                      image: mycanvasdata["responseData"]
                                                                          [index]
                                                                      [
                                                                      "user_info"][0]
                                                                  [
                                                          ...
                                                          ? DecorationImage(
                                                              image:
                                                                ...
                                                                "${mycanvasdata["responseData"][index]["user_info"][0]["profilePhoto"]}",
                                                              ),
                                                              fit: BoxFit.fill)
                                                          : DecorationImage(
                                                              image: AssetImage(
                                                              ...
                                                              GestureDetector(
                                                                  onTap:
                                                                    ...
                                                                    Navigator.push(
                                                                        ...
                                                                        MaterialPageRoute(
                                                                            builder: (context) =>
                                                                                MySpace(allphanesuserdata!.getString("userid"), mycanvasdata["responseData"][index]["user_info"][0]["_id"])));
                                                                  },
                                                                  child: Text(
                                                                      "${mycanvasdata["responseData"][index]["user_info"][0]["showName"]}",
                                                                      style: TextStyle(
                                                                          fontSize: 2.5
                                                                              .w,
                                                                      ...
                                                                      textAlign:
                                                                          TextAlign
                                                                              .justify)))),
                                                  Text(
                                                    "${calculatetime(mycanvasdata["responseData"][index]["createdAt"])}",
                                                    style: TextStyle(
                                                        color: Colors.grey,
                                                        fontSize: 12),
                                                  ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              IconButton(
                                                ...
                                                icon: Icon(
                                                  Icons.bookmark,
                                                  color: mycanvasdata["responseData"]
                                                                          [index]
                                                                      ["isFav"]
                                                                  .length >
                                                              0 &&
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        mycanvasdata["responseData"][index]
                                                    ["postTitle"] !=
                                                "Quick Post"
                                            ? "${mycanvasdata["responseData"][index]["postTitle"]}"
                                            : "",
                                        style: TextStyle(
                                            color: Colors.black,
                                ...
                                mycanvasdata["responseData"][index]["postInfo"]
                                            .length >
                                        0
                                    ? Padding(
                                        padding: const EdgeInsets.all(8.0),
                                          ...
                                          children: [
                                            Image(
                                                image: CachedNetworkImageProvider(
                                                    "${mycanvasdata["responseData"][index]["postInfo"][0]["postImagePath"]}")
                                              ...
                                              children: [
                                                Text(
                                                    mycanvasdata["responseData"]
                                                                ...
                                                                ["keywords2"] !=
                                                            null
                                                        ? "${mycanvasdata["responseData"][index]["keywords2"]}"
                                                        : "",
                                                    style: TextStyle(
                                                        color: Colors.blue,
                                                        fontSize: 14))
                                    ...
                                    : Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            Text(
                                              "${mycanvasdata["responseData"][index]["postDescription"]}",
                                              style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 14),
                                            ...
                                            children: [
                                                            ...
                                                            child:
                                                              ...
                                                              onTap: () async {
                                                                ...
                                                                Navigator.push(
                                                                    ...
                                                                    MaterialPageRoute(
                                                                        builder: (context) => MySpace(
                                                                            allphanesuserdata!.getString("userid"),
                                                                            mycanvasdata["responseData"][index]["shareUserId"])));
                                                              },
                                                              child: Container(
                                                                height: 6.h,
                                                                width: 6.h,
                                                                decoration: BoxDecoration(
                                                                    shape: BoxShape.circle,
                                                                    //color: Colors.green,
                                                                    image: mycanvasdata["responseData"][index]["shareProfile"] != ""
                                                                        ? DecorationImage(
                                                                            image: CachedNetworkImageProvider(
                                                                              "${mycanvasdata["responseData"][index]["shareProfile"]}",
                                                                            ),
                                                                            fit: BoxFit.fill)
                                              ...
                                              mycanvasdata["responseData"]
                                                  ...
                                                  : Padding(
                                                      ...
                                                      child: Image(
                                                        image: CachedNetworkImageProvider(
                                                            '${mycanvasdata["responseData"][index]["shareGalleryInfo"]}'),
                                                        fit: BoxFit.contain,
                                                      ),
                                                    ),
                                              mycanvasdata["responseData"]
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          Row(
                                                            ...
                                                            children: [
                                                              Text(
                                                                "${mycanvasdata["responseData"][index]["shareDescription"]}",
                                                                style: TextStyle(
                                                                    color: Colors
                                                                        .black,
                                                                    fontSize:
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () {
                                          if (allphanesuserdata!
                                                  .getString("userid") ==
                                              mycanvasdata["responseData"]
                                                  [index]["referenceUserId"]) {
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        "${mycanvasdata["responseData"][index]["totalLikes"]} Likes  ${mycanvasdata["responseData"][index]["totalComment"]} Comments",
                                        style: TextStyle(
                                                ...
                                                decoration: BoxDecoration(
                                                    ...
                                                    image: allphanesuserdata!
                                                        ...
                                                        ? DecorationImage(
                                                            image:
                                                                CachedNetworkImageProvider(
                                                              "${allphanesuserdata!.getString("profilephoto")}",
                                                            ),
                                                            fit: BoxFit.fill)
                                                        : DecorationImage(
                                                            image: AssetImage(
                                                    ...
                                                    itemBuilder:
                                                      ...
                                                      return Padding(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              Text(
                                                                "${mycanvasdata["responseData"][index]["user_comment"][index1]["messageText"]}",
                                                                style: TextStyle(
                                                                    color: Colors
                                                                        .black),
                                                              )
