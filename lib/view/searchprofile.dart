              ...
              searchitem != null
                  ? Padding(
                      ...
                      child: Container(
                        ...
                        width: MediaQuery.of(context).size.width,
                        constraints:
                            BoxConstraints(maxHeight: 50.h, minHeight: 25.h),
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            color: Colors.white),
                        child: searchitem["responseData"].length > 0
                            ? ListView.builder(
                                itemCount: searchitem != null
                                    ? searchitem["responseData"].length
                                    : 0,
                                itemBuilder: (BuildContext context, index) {
                                  return Padding(
                                    ...
                                    child: ListTile(
                                      ...
                                      leading: Padding(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              image: searchitem["responseData"]
                                                              [index]
                                                          ["profilePhoto"] !=
                                                      ""
                                                  ? DecorationImage(
                                                      image: CachedNetworkImageProvider(
                                                          "${searchitem["responseData"][index]["profilePhoto"]}"),
                                                      fit: BoxFit.contain)
                                                  : DecorationImage(
                                                      image: AssetImage(
                                      ...
                                      title: Text(
                                          "${searchitem["responseData"][index]["showName"]}"),
                                      trailing: Icon(
