          ...
          child: creationsdata == null
              ...
              : Stack(
                  children: [
                    ...
                    ListView.builder(
                      itemCount: creationsdata != null
                          ? creationsdata["responseData"].length
                          : 0,
                      itemBuilder: (BuildContext context, index) {
                              ...
                              children: [
                                              ...
                                              child: GestureDetector(
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                      shape: BoxShape.circle,
                                                      //color: Colors.green,
                                                      image: creationsdata["responseData"]
                                                                          [index]
                                                                      [
                                                                      "user_info"][0]
                                                                  [
                                                          ...
                                                          ? DecorationImage(
                                                              image:
                                                                ...
                                                                "${creationsdata["responseData"][index]["user_info"][0]["profilePhoto"]}",
                                                              ),
                                                              fit: BoxFit.fill)
                                                          : DecorationImage(
                                                              image: AssetImage(
                                                              ...
                                                              GestureDetector(
                                                                  onTap:
                                                                    ...
                                                                    Navigator.push(
                                                                        ...
                                                                        MaterialPageRoute(
                                                                            builder: (context) =>
                                                                                MySpace(allphanesuserdata!.getString("userid"), creationsdata["responseData"][index]["user_info"][0]["_id"])));
                                                                  },
                                                                  child: Text(
                                                                      "${creationsdata["responseData"][index]["user_info"][0]["showName"]}",
                                                                      style: TextStyle(
                                                                          fontSize: 2.5
                                                                              .w,
                                                                      ...
                                                                      textAlign:
                                                                          TextAlign
                                                                              .justify)))),
                                                  Text(
                                                    "${calculatetime(creationsdata["responseData"][index]["createdAt"])}",
                                                    style: TextStyle(
                                                        color: Colors.grey,
                                                        fontSize: 12),
                                                  ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              IconButton(
                                                ...
                                                icon: Icon(
                                                  Icons.bookmark,
                                                  color: creationsdata["responseData"]
                                                                          [
                                                                          index]
                                                                      ["isFav"]
                                                                  .length >
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        creationsdata["responseData"][index]
                                                    ["postTitle"] !=
                                                "Quick Post"
                                            ? "${creationsdata["responseData"][index]["postTitle"]}"
                                            : "",
                                        style: TextStyle(
                                            color: Colors.black,
                                ...
                                creationsdata["responseData"][index]["postInfo"]
                                            .length >
                                        0
                                    ? Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Image(
                                            image: CachedNetworkImageProvider(
                                                "${creationsdata["responseData"][index]["postInfo"][0]["postImagePath"]}")
                                    ...
                                    : Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text(
                                          "${creationsdata["responseData"][index]["postDescription"]}",
                                          style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 14),
                                            ...
                                            children: [
                                                                ...
                                                                Navigator.push(
                                                                    ...
                                                                    MaterialPageRoute(
                                                                        builder: (context) => MySpace(
                                                                            ...
                                                                            creationsdata["responseData"][index]["shareUserId"])));
                                                              },
                                                              child: Container(
                                                                height: 6.h,
                                                                width: 6.h,
                                                                decoration: BoxDecoration(
                                                                    shape: BoxShape.circle,
                                                                    //color: Colors.green,
                                                                    image: creationsdata["responseData"][index]["shareProfile"] != ""
                                                                        ? DecorationImage(
                                                                            image: CachedNetworkImageProvider(
                                                                              "${creationsdata["responseData"][index]["shareProfile"]}",
                                                                            ),
                                                                            fit: BoxFit.fill)
                                              ...
                                              creationsdata["responseData"]
                                                  ...
                                                  : Padding(
                                                      ...
                                                      child: Image(
                                                        image: CachedNetworkImageProvider(
                                                            '${creationsdata["responseData"][index]["shareGalleryInfo"]}'),
                                                        fit: BoxFit.contain,
                                                      ),
                                                    ),
                                              creationsdata["responseData"]
                                                  ...
                                                  : Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            "${creationsdata["responseData"][index]["shareDescription"]}",
                                                            style: TextStyle(
                                                                color: Colors
                                                                    .black,
                                                                fontSize: 12),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        "${creationsdata["responseData"][index]["totalLikes"]} Likes  ${creationsdata["responseData"][index]["totalComment"]} Comments",
                                        style: TextStyle(
