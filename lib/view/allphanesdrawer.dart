        ...
        children: [
          ...
          ListTile(
            ...
            title: Text(
              "Home",
              style: TextStyle(
                  color: Color.fromRGBO(154, 205, 50, 1), fontSize: 2.h),
            ),
            trailing: const Icon(
          ...
          ListTile(
            onTap: () async {
              ...
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => MySpace(uid, uid)));
            },
            leading: Icon(
          ...
          ListTile(
            onTap: () {
              Navigator.pop(context);
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => Creations()));
            },
            leading: Icon(
              Icons.store,
              color: Colors.white,
